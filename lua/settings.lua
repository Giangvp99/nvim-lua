...
opt('o', 'hidden', O.hidden_files) -- Enable modified buffers in background
opt('w', 'wrap', O.wrap_lines) -- Disable line wrap
...
opt('w', 'number', O.number) -- Print line number
...
opt('w', 'relativenumber', O.relative_number) -- Relative line numbers
