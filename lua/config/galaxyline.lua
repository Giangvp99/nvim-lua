...
gls.left[7] = {
    GitBranch = {provider = 'GitBranch', condition = check_git_workspace, highlight = {colors.fg2, colors.bg1}}
}
gls.left[8] = {
    Space = {
        provider = function()
...
gls.left[9] = {DiffAdd = {provider = 'DiffAdd', icon = '  ', highlight = {colors.bright_green, colors.bg1}}}
gls.left[10] = {
    DiffModified = {provider = 'DiffModified', icon = ' ', highlight = {colors.bright_orange, colors.bg1}}
}
gls.left[11] = {DiffRemove = {provider = 'DiffRemove', icon = '  ', highlight = {colors.bright_red, colors.bg1}}}
...
-- }
gls.right[1] = {
    DiagnosticWarn = {provider = 'DiagnosticWarn', icon = '  ', highlight = {colors.bright_yellow, colors.bg1}}
}
gls.right[2] = {
    DiagnosticError = {provider = 'DiagnosticError', icon = '  ', highlight = {colors.bright_red, colors.bg1}}
}
gls.right[3] = {
    DiagnosticHint = {provider = 'DiagnosticHint', icon = '  ', highlight = {colors.bright_blue, colors.bg1}}
}

gls.right[4] = {
    DiagnosticInfo = {provider = 'DiagnosticInfo', icon = '  ', highlight = {colors.bright_blue, colors.bg1}}
}
gls.right[5] = {
    RightSepNested = {
        provider = function()
