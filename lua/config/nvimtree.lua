...
require'nvim-tree'.setup {
    ...
    view = {
        ...
        mappings = {
            custom_only = true,
            list = {
                {key = {"o", "l"}, cb = tree_cb("edit")}, {key = {"<CR>"}, cb = tree_cb("cd")},
                ...
                {key = "h", cb = tree_cb("close_node")}, {key = "<Tab>", cb = tree_cb("preview")},
                {key = "K", cb = tree_cb("first_sibling")},
                {key = "J", cb = tree_cb("last_sibling")},
                {key = "I", cb = tree_cb("toggle_ignored")},
                {key = "H", cb = tree_cb("toggle_dotfiles")}, {key = "R", cb = tree_cb("refresh")},
                {key = "a", cb = tree_cb("create")}, {key = "d", cb = tree_cb("remove")},
                ...
                {key = "s", cb = tree_cb("system_open")}, {key = "q", cb = tree_cb("close")},
